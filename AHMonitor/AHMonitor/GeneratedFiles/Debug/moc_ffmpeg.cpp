...
void FFmpegThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        FFmpegThread *_t = static_cast<FFmpegThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (FFmpegThread::*_t)(const QImage & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FFmpegThread::receiveImage)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject FFmpegThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_FFmpegThread.data,
      qt_meta_data_FFmpegThread,  qt_static_metacall, nullptr, nullptr}
};
...
void *FFmpegThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FFmpegThread.stringdata0))
        return static_cast<void*>(const_cast< FFmpegThread*>(this));
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        FFmpegWidget *_t = static_cast<FFmpegWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject FFmpegWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_FFmpegWidget.data,
      qt_meta_data_FFmpegWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void *FFmpegWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FFmpegWidget.stringdata0))
        return static_cast<void*>(const_cast< FFmpegWidget*>(this));
